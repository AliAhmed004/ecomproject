     ...
     <div class="row">
       <div class="col-md-12">
        <div class="checkout-area">
          <form action="" id="items_order" method="post">
            <div class="row">
              <div class="col-md-8">
                    ...
                    <div class="panel panel-default aa-checkout-coupon">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body ">
                          <input type="text" placeholder="Coupon Code" name="coupon_code" class="aa-coupon-code">
                          <input type="submit" value="Apply Coupon" class="aa-browse-btn apc">
                      ...
                      <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="name" placeholder="Name*" {{$required}} value="{{$customer_details['name']}}">
                              </div>                             
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="email" name="email" placeholder="Email Address*" {{$required}} value="{{$customer_details['email']}}">
                              </div>                             
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="city" placeholder="City" {{$required}} value="{{$customer_details['city']}}">
                              </div>                             
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="tel" name="mobile" placeholder="Phone*" {{$required}} value="{{$customer_details['mobile']}}">
                              </div>
                            </div>
                          </div> 
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" rows="3" name="address" {{$required}} >{{$customer_details['address']}}</textarea>
                              </div>                             
                            </div>                            
                          </div>   
                  ...
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$item->title}}<strong> x  {{$item->qty}}</strong><br>{{$item->color}} / {{$item->size}}</td>
